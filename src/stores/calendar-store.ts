...
const sampleEvents: CalendarEvent[] = [
  ...
  },
  {
    ...
    location: '整備工場',
    assignedToName: '渡辺',
    assignedToColor: 'bg-indigo-100 text-indigo-700',
    customerName: '吉田美香',
    recurrence: 'none',
  ...
  },
  {
    ...
    location: '店舗',
    assignedToName: '伊藤',
    assignedToColor: 'bg-orange-100 text-orange-700',
    customerName: '加藤健一',
    recurrence: 'none',
